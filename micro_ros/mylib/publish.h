...
extern int cnt_pub, cnt_imu, cnt_control, cnt_bme;
...
extern rcl_publisher_t temp_pub;
extern rcl_publisher_t humi_pub;
...
extern sensor_msgs__msg__Temperature temp_msg;
extern sensor_msgs__msg__RelativeHumidity humi_msg;
